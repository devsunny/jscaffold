...
public class SQLScriptParser2 {
	...
	public SQLScriptParser2(SQLScriptLexer sqlLexer) throws IOException {
		super();
		this.tokenReader = new SQLScriptLookaheadTokenReader(3, sqlLexer);
	}

	public SQLScriptParser2(File sqlFile) throws IOException {
		this(new FileReader(sqlFile));
	}

	public SQLScriptParser2(String sqlText) throws IOException {
		this(new StringReader(sqlText));
	}

	public SQLScriptParser2(InputStream in, Charset encode) throws IOException {
		this(new InputStreamReader(in, encode));
	}

	public SQLScriptParser2(Reader reader) throws IOException {
		super();
