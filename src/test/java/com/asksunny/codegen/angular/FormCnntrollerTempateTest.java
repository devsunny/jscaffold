...
public class FormCnntrollerTempateTest {
	...
	public void test() throws Exception{
		...
		Field f = new Field(Types.INTEGER, 0, 0, 12, false, "id", CodeGenType.SEQUENCE, "0", "12", null, "0");
		f.setPrimaryKey(true);
		entity.addField(f);
		entity.addField(new Field(Types.VARCHAR, 0, 0, 12, false, "Name", CodeGenType.CITY, "0", "12", null, "0"));
		entity.addField(new Field(Types.INTEGER, 0, 0, 12, false, "TEST", CodeGenType.BIGINTEGER, "0", "12", null, "0"));
		entity.addField(new Field(Types.DATE, 0, 0, 12, false, "DOB", CodeGenType.DATE, "0", "12", "yyyy-MM-dd", "0"));
